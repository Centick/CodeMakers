    ...
    <div class="section about-us__section">
        <div class="container about-us__container">
            ...
            <div class="about-us__main-wrap">
                ...
                <p data-aos="fade-left">Мы - команда веб-разработчиков CodeMakers. Группа талантливых ребят, объединенных страстью к технологиям и инновациям. Мы разрабатываем веб-решения под современные задачи. Мы стремимся к качеству и креативности в каждом проекте.</p>
            ...
            <div class="history_main-wrap">
                ...
                <div class="history_text-wrap">
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Впервые мы познакомились 2 года назад.</p>
                    </div>
                </div>
                ...
                <div class="history_text-wrap">
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Проходят наши первые областные соревнование</p>
                    </div>
                </div>

                <div class="history_text-wrap">
                    <div class="history_block" data-aos="fade-up">
                        <h4>Проигрыш на соревнованиях</h4>
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Получив большой заряд мотивации, мы продолжили развиваться</p>
                    </div>
                </div>
                ...
                <div class="history_text-wrap">
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Ровно год назад мы поехали на наш первый хакатон за пределы города</p>
                    </div>
                </div>
                ...
                <div class="history_text-wrap">
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Наш уровень разработки стал расти</p>
                    </div>
                </div>
                <div class="history_text-wrap">
                    <div class="history_block" data-aos="fade-up">
                        <h4>Различные хакатоны</h4>
                        <p>Мы всё больше стали ездить и участвовать в хакатонах</p>
                    </div>
                    <div class="history_chronology_block">
                        6
                        <div class="points"></div>
                    ...
                    <div class="history_block" data-aos="fade-up">
                        ...
                        <p>Некоторые из нас уже зарабатывают деньги за счёт веб-разработки</p>
                    </div>
                </div>
                <div class="history_text-wrap">
                    ...
                    <div class="history_block typed_parent"><h4 id="typed_1">Это только начало...</h4></div>
                    <div class="history_block">
                        <span></span>
                    </div>
                </div>                
