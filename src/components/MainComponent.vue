...
<script setup lang="ts">
    ...
    function getVideos(): void {
        videos.value = [
            { id: 1, title: "Хакатон \"MininCode\" (г. Нижний Новгород)", src: 'https://vkvideo.ru/video_ext.php?oid=19529988&id=456240052&hd=2&autoplay=1', img: '1.png' },
            { id: 2, title: "Профориентационный хакатон \"Про ИТ\" (г. Липецк) ", src: 'https://vkvideo.ru/video_ext.php?oid=19529988&id=456239836&hd=2&autoplay=1', img: '2.png' },
            { id: 3, title: "Хакатон по кибербезопасности \"ИТ-вызов\" (г. Ижевск)", src: 'https://vkvideo.ru/video_ext.php?oid=19529988&id=456239831&hd=2&autoplay=1', img: '3.png' },
        ];
    }
